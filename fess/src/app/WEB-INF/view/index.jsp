...
<link href="${fe:url('/css/branding.css')}" rel="stylesheet"
	type="text/css" />
...
<body>
	<la:form styleClass="form-stacked" action="search" method="get"
		...
		<nav class="navbar navbar-light _bg-faded navbar-static-top pos-f-t">
		...
		<div class="container">
			<div class="row content">
				<div class="center-block searchFormBox">
					...
					<fieldset>
						<div class="clearfix">
							<div class="centered col-lg-8 col-md-10 col-sm-10 col-xs-8">
